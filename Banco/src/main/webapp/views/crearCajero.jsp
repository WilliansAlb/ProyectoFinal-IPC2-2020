            ...
            <div class="contenedorFlex" >
                <div class="ingreso" id="ingresoDpiCuenta">
                    <center>
                        ...
                        <form>
                            <div class="group">
                                <input type="text" id="dpiCajero" value="" required style="color: #EBEBEB !important;">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label for="dpiCajero">DPI</label>
                            </div>
                            <div class="group">
                                <input type="text" id="nombreCajero" required style="color: #EBEBEB !important;" value="">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                            ...
                            <div class="group">
                                ...
                                <br>
                                <select id="turnos" style="width:100%;">
                            ...
                            <div class="group">
                                ...
                                <br>
                                <select id="tipos" style="width:100%;">
                                    <option value="C">Cajero</option>
                                    <option value="G">Gerente</option>
                                </select>
                            </div>
                            <div class="group">
                                <input type="text" id="direccionCajero" required style="color: #EBEBEB !important;">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                            ...
                            <div class="group" id="campoPassword">
                                <input type="password" id="passwordCajero" required style="color: #EBEBEB !important;">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label for="passwordCajero">Contraseña</label>
                            </div>
                            <button class="learn-more buttonEspecial">Ingresar</button>
                        </form>
                    </center>
                </div>
            </div>
